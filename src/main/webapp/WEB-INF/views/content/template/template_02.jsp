	...
	function init_pagination(){
		...
		$('#resource_pagination').pagination({
			...
			onSelectPage:function(pageNumber, pageSize){
				...
				var grid_href = global_ctxPath + rootPath + "/attagrid/01?rows=" + pageSize + "&page=" + pageNumber;
...
<div class="easyui-layout" data-options="fit:true" id="resource_layout">
    ...
    <%-- /attagridd/01 中01表示图片 --%>
    <div data-options="onLoad:init_pagination,region:'center',border:false,title:'所有图片',cache:false,href:'${ pageContext.request.contextPath}/content/template/attagrid/01?rows=12&page=1'"></div>
</div>